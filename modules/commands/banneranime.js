...
for (let id of allAdmin) {
  ...
  const pathSave = __dirname + `/cache/bannerainme${Date.now()}.png`;
  ...
  await CheckExistAndDownload("https://drive.google.com/uc?export=download&id=1Zpok1pZBxGQ-tYsEq-Vxlb60rvxAyKrI", pathBackground);
